...
from DarkGod14Bot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER
...
def import_data(update: Update, context: CallbackContext):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                f"An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @DarkGod14"
            )

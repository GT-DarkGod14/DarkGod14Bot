...
def new_fed(update: Update, context: CallbackContext):
    ...
    if not fednam == "":
        ...
        if not x:
            update.effective_message.reply_text(
                f"Can't federate! Please contact @DarkGod14 if the problem persist."
            )
            return
...
def join_fed(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if not x:
            message.reply_text(
                f"Failed to join federation! Please contact @DarkGod14 if this problem persists!"
            )
            return
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if fban:
        ...
        if not x:
            message.reply_text(
                f"Failed to ban from the federation! If this problem continues, contact @DarkGod14."
            )
            return
...
def set_frules(update: Update, context: CallbackContext):
    ...
    if len(args) >= 1:
        ...
        if not x:
            update.effective_message.reply_text(
                f"Whoa! There was an error while setting federation rules! If you wondered why please ask in @DarkGod14!"
            )
            return
